...
> Repository development instructions for **invitation** (Service).
...
src/adapter, analytics, config, core, event-auth, handlers, invitation, prisma, security, utils
...
Multi-tenant invitations; tenant predicates and unique constraints matter.
