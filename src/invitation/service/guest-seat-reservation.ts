 ...
 *
 * A confirmation is only sent to the guest after a seat has been reserved for
 * the invitation, so a guest can never reach sign-up without a seatable
 * ticket. See AGENTS.md seat/ticket chain invariants.
 */
